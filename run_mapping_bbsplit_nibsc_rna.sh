...
~/programs/bbmap/bbsplit.sh build=2 path=~/data/data3/graham/nibsc/nibsc_references/rna_genomes/bbmap in1=$1 in2=$2 minratio=0.56 minhits=1 maxindel=16000 ambig2=split basename=split_%.sam outu1=$OUT_1 outu2=$OUT_2
